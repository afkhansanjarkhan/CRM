...
def index():
    ...
    while True:
        ...
        cv2.putText(img, "AIR CANVAS", (175, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        cv2.putText(img, "1. SCROLLER", (75, 105), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 1)
        cv2.putText(img, "2. DRAW    IN", (75, 175), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 1)
        cv2.putText(img, " Chose the Option ? Then, Click Q to enter ", (60, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                    (0, 0, 255), 2)
        cv2.putText(img, " Want to Exit ? Then, Click E to exit ", (95, 350), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                    (0, 0, 255), 2)
